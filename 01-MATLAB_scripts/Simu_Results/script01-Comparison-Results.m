...
%%
figure
plot( mean_elapsedTime_mat_comp(:,3:3:9) ) 
...
for ext_loop = 0:2
    ...
    SteadyState_MSD_vec(ext_loop*3 + 1) =  mean( mean_MSD_mat_comp((end-500):end, ext_loop*3 + 1) );  
    SteadyState_MSD_vec(ext_loop*3 + 2) =  mean( mean_MSD_mat_comp((end-500):end, ext_loop*3 + 2) ); 
    SteadyState_MSD_vec(ext_loop*3 + 3) =  mean( mean_MSD_mat_comp((end-500):end, ext_loop*3 + 3) ); 
