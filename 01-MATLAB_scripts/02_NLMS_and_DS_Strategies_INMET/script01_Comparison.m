...
graph_signal_type = 2;   % 2 is the original signal
...
for int_counter = 1:length(alg_param_vec) 
    ...
    [ mean_error_mat_comp(:,int_counter), mean_MSD_mat_comp(:,int_counter), ...
        mean_orig_MSD_mat_comp(:,int_counter), ~, ~, mean_elapsedTime_mat_comp(:,int_counter) ] = ...
...
save('./Simu_Results/01-simu-Comparison_LMS-RLS-NLMS','mean_error_mat_comp','mean_MSD_mat_comp','mean_orig_MSD_mat_comp',...
